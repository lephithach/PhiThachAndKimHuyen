const toolWrapper = document.querySelector(".toolbar");
const btnDarkMode = document.querySelector(".toolbar .btn-dark-mode");
const btnMinimize = document.querySelector(".toolbar .btn-minimize");
